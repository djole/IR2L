...
from double_rl_loop_main import ENV_NAME_BUTTON_EASY, ENV_NAME_BUTTON_HARDER, ENV_NAME_BOX, NUM_PROC, reward_cost_combinator, HAZARD_PUNISHMENT, REWARD_SCALE,\
    EPISODE_LENGTH
