...
POLICY_FILE = "pretrained_policy.pt"
...
def policy_instinct_combinator(policy_actions, instinct_outputs):
    ...
    ################# DEBUGGING ########################
    #print(f"ctrl_instinct_actions {ctrl_instinct_actions}")
    #print(f"ctrl_policy_actions {ctrl_policy_actions}")
    #print(f"instinct_control {instinct_control}")
    #print("#############################################")
    ####################################################
...
def inner_loop_ppo(
    ...
    actor_critic_policy = torch.load(POLICY_FILE)
    ...
    recurrent_hidden_states = torch.zeros(
        NUM_PROC, actor_critic_policy.recurrent_hidden_state_size, device=device)
    masks = torch.zeros(NUM_PROC, 1, device=device)
