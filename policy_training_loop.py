...
from double_rl_loop_main import ENV_NAME_BUTTON_EASY, ENV_NAME_BOX_NO_HAZARDS, NUM_PROC, policy_instinct_combinator, reward_cost_combinator, \
...
def instinct_loop_ppo(
    ...
    env_name = ENV_NAME_BOX_NO_HAZARDS #"Safexp-PointGoal1-v0"
