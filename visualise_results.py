...
def main(repeat_num):
    ...
    actor_critic_policy = torch.load(
        ...
        "/home/calavera/pulled_from_server/train_instinct_with_all_task_sensors/disconnect_policy_output_from_instinct_input/evaluate_on_push/model_rl_policy_latest.pt"
        # "/home/calavera/code/ITU_work/IR2L_master/pretrained_policy.pt"
    )
    actor_critic_instinct = torch.load(
        f"/home/calavera/pulled_from_server/train_instinct_with_all_task_sensors/disconnect_policy_output_from_instinct_input/evaluate_on_push/model_rl_instinct_latest.pt"
    )
    ...
    ob_rms = pickle.load(open(
        f"/home/calavera/pulled_from_server/train_instinct_with_all_task_sensors/disconnect_policy_output_from_instinct_input/evaluate_on_push/ob_rms.p",
        "rb"))
