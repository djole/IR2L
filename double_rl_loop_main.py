...
config_box_no_haz['goal_placements'] = [(-2, -2, 2, 2)]
config_box_no_haz['box_placements'] = [(-2, -2, 2, 2)]
...
def policy_instinct_combinator(policy_actions, instinct_outputs):
    ...
    instinct_control = torch.clamp(instinct_control, min=0.0001, max=1.0)
    instinct_control = ((instinct_control + 1) * 0.5) ** 0.01
